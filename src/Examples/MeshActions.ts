...
export class MeshActions {
    ...
    async CreateMeshes(): Promise<void> {
        ...
        this.cube.rotation = new Vector3(-Math.PI / 5, 1, 0);
    ...
    CreateActions(): void {
        ...
        (this.cube.actionManager as ActionManager).registerAction(
            new SetValueAction(
        ...
        (this.sphere.actionManager as ActionManager).registerAction(
